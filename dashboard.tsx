...
import { Image, View, SafeAreaView, FlatList, TouchableOpacity, Text, Alert } from 'react-native'
...
const Dashboard = (props : any) => {
  ...
  /*call back action from Dashboard Details to handle list API call */
    ...
    props.navigation.navigate('DashBoardDetails',
      {
        ...
        id: item.userId,
        title: item.title,
        mycallback: handleDashboardData
      })
  }
